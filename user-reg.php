...
<div class="signup-form">
    <form action="/examples/actions/confirmation.php" method="post">
        ...
        <div class="form-group">
        	<input type="text" class="form-control input-lg" name="username" placeholder="Your Name" required="required">
        </div>
		<div class="form-group">
    ...
    <div class="text-center">Already have an account? <a href="user-login.php">Login here</a></div>
</div>
</body>
</html>