...
<html lang="en">
  <head>
    ...
    <title>TOB Admin- Edit Books</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Edit Books</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="add_article.php">Add Books</a></li>
        </ul>
      </div>
...
function countPages($path) {
    ...
    if (basename($_FILES["fileToUploads"]["name"])!="")
     {
      ...
      $filenames=$n."-".basename($_FILES["fileToUploads"]["name"]);
        ...
        {
          echo "The image file ".basename( $_FILES["fileToUploads"]["name"]). " has been uploaded.";
  ...
  $sql="update articles set cat_id='$cid',title='$title',details='$details',tags='$tags',status='1',update_date='$dt',page_count='$pdfPages',file_size='$pdfSize'".$str1.$str2." where art_id='$art_id'";
