...
<html lang="en">
  <head>
    ...
    <title>TOB Admin - Add Books</title>
    <meta charset="utf-8">
...
$filenames=$n."-".basename($_FILES["fileToUploads"]["name"]);
  ...
  $sql="insert into articles (user_id,cat_id,title,details,tags,post_date,update_date,pic1,f_name,page_count,file_size,status) values ('$id','$cid','$title','$details','$tags','$dt','$dt','$filename','$filenames','$pdfPages','$pdfSize','1')";
