...
<html lang="en">
  ...
  ?>
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Edit Book</h1>
          <p></p>
        </div>
...
function countPages($path) {
  ...
  $sql="update articles set cat_id='$cid',title='$title',details='$details',tags='$tags',status='2',update_date='$dt',page_count='$pdfPages',file_size='$pdfSize'".$str1.$str2." where art_id='$art_id'";
