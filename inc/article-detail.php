         ...
         <li class="breadcrumb-item"><a href="#">Home</a></li>
          ...
          if (isset($_SESSION['user_id']))
          {
            if ($_SESSION['plan']==0)
            {
              ...
              echo "<a href=download_book.php?aid=".$rowArt['art_id']." class='btn btn-primary text-white' target='_blank'>DOWNLOAD</a>";
            }
         
              if ($_SESSION['plan']==1) {
               
                 echo "<a href=download.php?aid=".$rowArt['art_id']." style='color:blue'>DOWNLOAD NOW</a>";
              }

          }
        else {
         
           echo "<p class=text-danger>You must login to download the book</p>";
         }
           ?>
